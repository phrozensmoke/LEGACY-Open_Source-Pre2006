...
typedef enum resource_types {
  ...
  res_size, res_disk_geo, res_cache, res_baud, res_init_strings, res_modem_query, res_pppd_option,
  res_framebuffer
} hd_resource_types_t;
...
/* PhrozenSmoke - added here, modem query, get all 'ATI' info from modem */
typedef struct {
  union u_hd_res_t *next;
  enum resource_types type;
  char *ati0;
