...
def showSearchWindow(pair_list):
	...
	mainvbox.pack_start(GtkLabel(_("Search Results")),0,0,2)

	sc=GtkScrolledWindow()
	clist=GtkCList(2,[" "+_('Section')," "+_('Property')])
	...
	closebutt=GtkButton("  "+DIALOG_CLOSE+"  ")
...
def runSearchDialog(*args):
		...
		mainvbox.set_spacing(3)		
		mainvbox.pack_start(GtkLabel(_("Enter a search word")+":"),0,0,3)
		sentry=GtkEntry()
