...
class icewindow :
  ...
  (_("/_Help")+"/_"+BUG_REPORT_MENU+"...", "F5", file_bug_report,5005, ""),
	...
	self.leftmenu=menubar1.children()[0].get_submenu()
	...
	themelab = GtkLabel (_("Sound Theme")+":")
	...
	eventlab = GtkLabel (_("Sound Event")+":")
	...
	selsoundlab = GtkLabel (_("Selected Sound")+":")
	...
	eventtable.attach( GtkLabel(" "), 2, 3, 0, 1, (GTK.FILL), (GTK.FILL), 0, 0)
	eventtable.attach( GtkLabel(" "), 4, 5, 0, 1, (GTK.FILL), (GTK.FILL), 0, 0)
	...
	enablebutt = GtkCheckButton (_("Enabled"))
	...
	cmdlinelab = GtkLabel (_("Suggested Sound Server Command Line:"))
...
class iceoptions:
	...
	vbox1 = GtkVBox(0, 0)
	self.vbox1 = vbox1
	titlelab = GtkLabel (_("Ice Sound Manager Options"))
	...
	self.table2 = table2
	autocheck = GtkCheckButton(_("Automatically start IceSound server when Ice Sound Manager starts"))
	...
	copycheck = GtkCheckButton(_("Copy files instead of linking them"))
	...
	stdouttext = GtkCheckButton(_("Launch the IceSound Server in a terminal window"))
...
class dirdialog :
	...
	scrolledwindow1 =GtkScrolledWindow ()
	self.scrolledwindow1 = scrolledwindow1
	scrolledwindow1.set_usize(-2,120)
	htext = GtkText ()
...
class iceaudio :
	...
	localcheck = GtkCheckButton(_("Local Interface"))
	...
	autocheck = GtkCheckButton(_("Auto Audio Mode"))
