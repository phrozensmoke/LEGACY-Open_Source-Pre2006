...
####################################################
##########################################################
#	This is IcePref2 version 3.1 - It is an updated, overhauled, improved, and perfected
...
class Toggled(GtkVBox):  # changed from HBox to VBox, 5.15.2003
	def __init__(self, title='', value=''):
		GtkVBox.__init__(self, spacing=SP)
		self.set_border_width(BD)
		self.init_widgets(title)
...
class ImagePreviewer:
	def __init__(self,warn_type=0,restart_cmd=None,save_cmd=None):
		...
		#self.scbox.pack_start(GtkLabel("          "),1,1,0)
...
class Application(GtkWindow):
	...
	def __init__(self, argv):
		GtkWindow.__init__(self, title='IcePref2')
		global APP_WINDOW
		APP_WINDOW=self
		...
		self.vbox1 = GtkVBox(0,2)
		self.vbox1.set_border_width(0)
		self.vbox = GtkVBox(0,2)
	...
	def save_current_settings(self, *data):
		...
		try: 
			...
			f.write('# This configuration file automatically generated by IcePref2 %s (updated by PhrozenSmoke, June 2003) -- a Python-based IceWM configuration tool.\n\n' % VERSION)
			for name in ORDER:
				string =''
	...
	def init_menu(self):
		...
		self.run_root_button.connect("clicked",self.run_as_root_cb)
	...
	def init_notebook(self):
		...
		for tab in TABS:
			...
			if PULL_TAB==None: label = GtkLabel(" "+tab[0]+" ")
			widgets = tab[1]
