...
class keywintab:
	...
	mainvbox.pack_start(GtkLabel(_(" Select your desired keyboard repeat rate: ")),0,0,3)	

	self.clickcheck=GtkCheckButton(" "+_("Allow keyboard auto-repeat"))
...
class keysoundtab:
	...
	mainvbox.set_spacing(4)
	self.mainvbox=mainvbox
	mainvbox.pack_start(GtkLabel(_("Keyboard Sounds")),0,0,8)	

	mainframe=GtkFrame()
	mainframe.set_label(_("Keyboard Click"))
	self.clickcheck=GtkCheckButton(" "+_("Allow keyboard clicks"))
	TIPS.set_tip(self.clickcheck,_("Allow keyboard clicks"))
	self.clickcheck.set_active(1)
	
	chb=GtkHBox(0,0)
	chb.set_spacing(3)
	chb.pack_start(GtkLabel(_("Volume")+" "),0,0,0)
	...
	chb1=GtkHBox(0,0)
	chb1.set_spacing(3)
	chb1.pack_start(GtkLabel(_("Volume")+" "),0,0,0)
	self.clickcheck1=GtkCheckButton(" "+_("Allow keyboard beeps"))
	...
	chb2=GtkHBox(0,0)
	chb2.set_spacing(3)
	chb2.pack_start(GtkLabel(_("Pitch")+" (hz) "),0,0,0)
	...
	chb3=GtkHBox(0,0)
	chb3.set_spacing(3)
	chb3.pack_start(GtkLabel(_("Duration")+" (ms) "),0,0,0)
	...
	for ii in [chb1,chb2,chb3,chb]:
		ii.children()[0].set_alignment(0.0,1.0)
	abutton=GtkButton(_("Apply"))
	TIPS.set_tip(abutton,_("Apply"))
	rbutton=GtkButton(_("Reset"))
	TIPS.set_tip(rbutton,_("Reset"))
...
class keywin:
  ...
  (_("/_Help")+"/_"+BUG_REPORT_MENU+"...", "F5", file_bug_report,5013, ""),
	...
	self.title_lab=GtkLabel(_("Keyboard"))
	...
	icepan.pack_start(GtkLabel(_("Additional IceWM Shortcut Keys")),0,0,3)
	...
	notebook.append_page(keywinta.mainvbox, GtkLabel(_("Repetition")))
	notebook.append_page(BELL_TAB.mainvbox, GtkLabel(_("Sound")))
	notebook.append_page(short_tab.createPanel(0), GtkLabel(_("Shortcut Keys")))
	notebook.append_page(icepan, GtkLabel(_("IceWM Keys")))
