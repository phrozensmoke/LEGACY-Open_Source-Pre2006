...
#############################################################################
########
# With Modifications by Erica Andrews (PhrozenSmoke@yahoo.com), February 2003
# This is a modified version of IceMe 1.0.0 ("IceWMCP Edition"), optimized for
# IceWM ControlPanel.
#
...
try:
        NORMAL_FONT = load_font("-*-helvetica-medium-r-normal-*-14-*") # larger fonts added 2.21.2003
        BOLD_FONT   = load_font("-*-helvetica-medium-o-normal-*-14-*") # larger fonts added 2.21.2003
except:
