...
if __name__== "__main__" :
        mods = ( "IceWMCP.py",
             ...
             "pyspool.py",
             "phrozenclock.py",
             "IceWMCP.IconSelection.py",
             "IceWMCPCursors.py",
             "icepref_td.py",
             "IceWMCP_gtk.PCCard.py",
             "IceWMCPSystem.py" )
        mods.sort()
        if len(sys.argv)>1:
                ar=sys.argv[1]
                ...
                if ar=="icepref.py": icepref.run()
                if ar=="icesound.py": icesound.run()
                if ar=="pyspool.py": pyspool.run()
                if ar=="phrozenclock.py": phrozenclock.run()
                if ar=="icepref_td.py": icepref_td.run()
                if ar=="IceWMCP.IconSelection.py": IceWMCP.IconSelection.run_icons()
                if ar=="IceWMCP_gtk.PCCard.py": IceWMCP_gtk.PCCard.run()
