...
#DJM  import IconSelectionDialog 
    ...
    def parseLineList(self,string_list):
        ...
        try:
                for ii in ff:
                        ...
                        #if str(mywmclass).lower().find("callerid")>-1: print "gtk.CallerID:  "+myval
                        self.window_options[mywmclass]=d
                return {}
        except:
                return {}
...
#DJM        icon_dlg = IconSelectionDialog.IconSelectionDialog(7)
#DJM        icon_dlg.show_all()
    ...
    def update_image(self,image_file):
                ...
                try:
                        ...
                        self.prevlay.put(gtk.Label(" "),1,1)
    ...
    def show_addkey(self,*args):
        ...
        mb.pack_start(gtk.HSeparator(),0,0,4)
        hb=gtk.HBox(0,0)
        hb2=gtk.HBox(0,0)
        wmctext=gtk.Entry()
        wmntext=gtk.Entry()
        hb.pack_start(gtk.Label("WM_CLASS:  "),0,0,0)
        hb.pack_start(wmctext,1,1,0)
        mb.pack_start(hb,1,1,1)
        hb2.pack_start(gtk.Label("WM_NAME:   "),0,0,0)
        ...
        hb3.pack_start(gtk.Label("     "),1,1,1)
    ...
    def fileok(self, *args):
                ...
                if p==1:
                        self.iconentry.set_text(str(dirvalue))
                        self.update_image(str(dirvalue))
                else:
                ...
                for ii in k:
                        ...
                        for jj in h:
                                if jj=="icon":
                                        ...
                                        #if str(ii).lower().find("callerid")>-1: print "gtk.CallerID:  "+ival
                                else: 
